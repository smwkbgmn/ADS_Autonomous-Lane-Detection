"""
Main Integration Script for CARLA Lane Detection (REFACTORED OOP VERSION)

This is the CLEAN, refactored version using proper OOP architecture.
...
class LaneKeepingAssist:
    """
    Lane Keeping Assist System (REFACTORED).

    CLEAN ARCHITECTURE:
        This class is now SIMPLE - just orchestrates components!
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Lane Keeping Assist System for CARLA (Refactored OOP Version)"
    )
