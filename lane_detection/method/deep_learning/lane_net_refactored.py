"""
Refactored Deep Learning Lane Detection (OOP Version)

This is the refactored version using the new OOP architecture.
Wraps the existing DLLaneDetector to implement the new interface.
...
# Import the original DL detector
from method.deep_learning.lane_net import DLLaneDetector as OriginalDLLaneDetector


class DLLaneDetectorRefactored(LaneDetector):
    """
    Refactored Deep Learning lane detector.
    ...
    def __init__(self,
        ...
        # Create the original detector internally
        # COMPOSITION: We "have a" detector, not "are a" detector
        self._detector = OriginalDLLaneDetector(
...
ANALOGY (C++):
    ...
    class DLLaneDetectorRefactored : public LaneDetector {
...
if __name__ == "__main__":
    # Example usage
    print("Testing Refactored DL Detector...")

    detector = DLLaneDetectorRefactored(model_type='pretrained')
