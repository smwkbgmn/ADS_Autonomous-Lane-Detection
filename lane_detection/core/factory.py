...
class DetectorFactory:
    ...
    def create(self, detector_type: Optional[str] = None, **kwargs) -> LaneDetector:
        ...
        if detector_type == 'cv':
            ...
            raise ValueError(f"Unknown detector type: {detector_type}. Use 'cv' or 'dl'.")
    ...
    def _create_cv_detector(self, **kwargs) -> LaneDetector:
        ...
        from method.computer_vision.cv_lane_detector_refactored import CVLaneDetectorRefactored
        ...
        params = {
            ...
            'hough_min_line_len': kwargs.get('hough_min_line_len', cfg.hough_min_line_len),
            'hough_max_line_gap': kwargs.get('hough_max_line_gap', cfg.hough_max_line_gap),
            'smoothing_factor': kwargs.get('smoothing_factor', cfg.smoothing_factor),
        }

        return CVLaneDetectorRefactored(**params)
    ...
    def _create_dl_detector(self, **kwargs) -> LaneDetector:
        ...
        from method.deep_learning.lane_net_refactored import DLLaneDetectorRefactored
        ...
        return DLLaneDetectorRefactored(**params)
